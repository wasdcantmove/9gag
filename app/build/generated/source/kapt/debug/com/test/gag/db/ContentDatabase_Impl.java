...
import com.test.gag.db.dao.ContentDao_Impl;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `Content` (`id` INTEGER, `gags` TEXT, PRIMARY KEY(`id`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'f6e6e8c9e5c7aa357678a3dfe5434d5e')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsContent = new HashMap<String, TableInfo.Column>(2);
        _columnsContent.put("id", new TableInfo.Column("id", "INTEGER", false, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsContent.put("gags", new TableInfo.Column("gags", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoContent.equals(_existingContent)) {
          return new RoomOpenHelper.ValidationResult(false, "Content(com.test.gag.db.models.DbContent).\n"
                  + " Expected:\n" + _infoContent + "\n"
                  + " Found:\n" + _existingContent);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "f6e6e8c9e5c7aa357678a3dfe5434d5e", "c1277cf029f4fa2ad8b8c6475d79683d");
