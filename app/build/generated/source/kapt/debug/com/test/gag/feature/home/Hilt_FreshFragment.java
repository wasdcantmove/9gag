 ...
 */
public abstract class Hilt_FreshFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FreshFragment_GeneratedInjector) this.generatedComponent()).injectFreshFragment(UnsafeCasts.<FreshFragment>unsafeCast(this));
    }
  }
