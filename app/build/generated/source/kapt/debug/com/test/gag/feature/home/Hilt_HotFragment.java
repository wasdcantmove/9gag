 ...
 */
public abstract class Hilt_HotFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HotFragment_GeneratedInjector) this.generatedComponent()).injectHotFragment(UnsafeCasts.<HotFragment>unsafeCast(this));
    }
  }
