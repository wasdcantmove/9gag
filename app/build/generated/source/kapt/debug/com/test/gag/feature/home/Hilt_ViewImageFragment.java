 ...
 */
public abstract class Hilt_ViewImageFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ViewImageFragment_GeneratedInjector) this.generatedComponent()).injectViewImageFragment(UnsafeCasts.<ViewImageFragment>unsafeCast(this));
    }
  }
